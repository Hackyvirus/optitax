    ...
    <AuthShell cfg={cfg} mode="login">
      ...
      {sent ? (
        <div style={{ padding:20, background:"#f0fdf4", border:"1px solid #bbf7d0", borderRadius:12, textAlign:"center" }}>
          ...
          <a href="/employee/login" style={{ fontSize:13, fontWeight:600, color:cfg.color }}>Back to login →</a>
        </div>
      ) : (
        <form onSubmit={submit}>
          ...
          <a href="/employee/login" style={{ display:"block", textAlign:"center", marginTop:14, fontSize:13, color:"#64748b", textDecoration:"none" }}>← Back to login</a>
        </form>
      )}
    </AuthShell>
  );
